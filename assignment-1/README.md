...
- ![SG of bastion server](./screenshots/task05.png)
...
- ![Inbound rule of private ec2](./screenshots/task05.1.png)
...
- ![ssh to bastion host](./screenshots/task06.1.png)
...
- ![ssh into private ec2 from bastion host](./screenshots/task06.2.png)

- Enable CloudWatch monitoring for both EC2 instances.
- ![enable CloudWatch setting](./screenshots/task06.4.png)

- Verify the CloudWatch metrics for the instances.
- ![metric table for running instances](./screenshots/task06.5.png)
